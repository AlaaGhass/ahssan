      ...
      <div class="detail-box">
        <div class="heading_container">
          ...
          <h1>
            ...
            <span style="font-size: 17px;"> [البقرة: 274]</span>
           </h1>
      ...
      <div class="animal_container">
        ...
        <div class="box b2">
          ...
          <div class="detail-box">
            <h5>
            <?php
				                  	$stmt2 = $con->prepare("SELECT COUNT(id) FROM page_user");

	       	                        $stmt2->execute();

		                           $countU=  $stmt2->fetchColumn();
					
									
                   ///////////////
                   $stmt2 = $con->prepare("SELECT COUNT(id) FROM pageinstitution");

                   $stmt2->execute();

               $countItems=  $stmt2->fetchColumn();
$sum=$countU+$countItems;
   echo $sum; 
                   
                   ?>
            </h5>
            <p>
        طلب تبرع لافراد ومؤسسات
            </p>
          </div>
        </div>
        <div class="box b1">
  ...
  <section class="food_section layout_padding" id="upd">
    <div class="container">
      ...
      <div class="food_container">
        <?php
          include 'connect.php';
      $stmt = $con->prepare("SELECT * FROM fundraising LIMIT 3 ");
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-3">
          <div class="info_form pl-lg-4">
            <h5>
            عزيزي المستفيد يسعدنا مشاركة رئيك
            </h5>
            <form action="comand.php"   method="post" >
              <input type="text" name="text" placeholder="  عزيزي المستفيد يسعدنا مشاركة رئيك" />
              <button type="submit">
                ارسال
              </button>
            </form>
