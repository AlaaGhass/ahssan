...
<body>
  ...
  <?php
  include 'connect.php';
  $stmtActive = $con->prepare("UPDATE pageinstitution	 SET nots=1 ");
  ...
  $get = $con->prepare("SELECT * FROM pageinstitution WHERE view=0");
$get->execute();
...
?>
       ...
       echo "<tr>";
             ...
             //     echo "<td>" . $r['serial'] . "</td>";
                  ...
                  echo "<td>" . $r['location'] . "</td>";?>
                        <td> <a href="deletpage.php?id=<?php echo $r['id'] ?>">ارشفة</a></td>
                        <td> <a href="printi.php?id=<?php echo $r['id'] ?>">طباعة</a></td>
  ...
  ?>
<h2 class="btn btn"><a style="background-color:#edd600; text-align:right" href="deletepage.php">الارشيف</a></h2>
  <!-- end ani section -->
</div>
