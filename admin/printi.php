...
<body>
  ...
  $get = $con->prepare("SELECT * FROM pageinstitution WHERE id=$Id");
$get->execute();
...
?>
  ...
  <table  class="table detail-box" style="text-align:right">
     ...
     echo "<td>";			
                  ...
                  echo "","الاسم",": " . $r['name'] ,"</td>";
                  echo "<td>"; echo "","النشاط",": "  . $r['active'] . "</td>";
                  echo "</tr>";
                  echo "<tr>";
             ...
             echo "<tr>";
             echo "<td>","عدد الافراد",": "  . $r['countSingulr'] . "</td>";
               echo "<td>","عدد الحالات المزمنة",": "  . $r['countDisease'] . "</td>";
               echo "</tr>";
             echo "<tr>";
              echo "<td>","العنوان",": "  . $r['location'] . "</td>";
              echo "<td>","رقم الحساب البنكي",": "  . $r['num'] . "</td>";
             echo "</tr>";
             echo "<tr>";
